...
def raoult_law_kvalue( T, P, a, gamma):
    ...
    #  gamma - Activity coefficients for use in a modified Raoult's law. User can input "False" if gamma value is not necessary.
    ...
    #
    #  Example: (eg: raoult_law_kvalue(500, 2, [1,2,3]))        
    #  
